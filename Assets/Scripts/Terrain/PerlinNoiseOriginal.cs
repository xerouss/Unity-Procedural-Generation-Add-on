...
/// It uses Ken Perlin's original implementation which I did not implement
/// But creates the terrain using it which I implemented
/// </summary>
namespace ProceduralGenerationAddOn
{
    public class PerlinNoiseOriginal
    {
        #region Constants
